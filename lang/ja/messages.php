...
return [
    ...
    'commonMessageForInputError' => '指定されたデータは無効でした。',
    'registered' => '登録は正常に完了しました！',
    'registerFailed' => '登録に失敗しました！',
    'loggedIn' => 'ユーザーは正常にログインしています！',
    'loginFailed' => 'Not authenticated!',
    'loggedOut' => 'ユーザーは正常にログアウトされました！',
    'matchOldPassword' => ':attribute は現在のパスワードと一致します。',
    'notMatchCurrentPassword' => ':attribute が一致しません。',
    'runCommandText' => 'Please run below commands',

    'crud' => [
        'stored' => 'データは正常に保存されます！',
        'storeFailed' => '何か問題でも！ 保存に失敗しました。',
        'updated' => 'データが正常に更新されました！',
        'updateFailed' => '何か問題でも！ 更新失敗。',
